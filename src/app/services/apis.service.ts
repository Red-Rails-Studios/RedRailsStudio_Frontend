...
export class APISService {
  ...
  getPower(sessionName: string, playerUid: string): Observable<number>{
    return this.http.get<number>(`http://localhost:8080/session/${sessionName}/player/${playerUid}/power`);
  }

  getEmployee(sessionName: string, playerUid: string): Observable<number>{
    return this.http.get<number>(`http://localhost:8080/session/${sessionName}/player/${playerUid}/employees`);
  }
}